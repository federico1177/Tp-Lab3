      ...
      try {
        ...
        transactions.forEach((transaction) => {
          ...
          if (!cryptos[crypto_code]) {
            cryptos[crypto_code] = { amount: 0, crypto_code: crypto_code };
          }
